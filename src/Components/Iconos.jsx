...
export function ArrowIcon() {
  return (
    <svg
      aria-label="Icono de comilla angular hacia abajo"
      className="x1lliihq x1n2onr6 x5n08af"
      fill="currentColor"
      height="12"
      role="img"
      ...
      width="12"
    >
      <title>Icono de comilla angular hacia abajo</title>
...
export function SoundIcon() {
  return (
    <svg
      aria-label="Se está reproduciendo audio"
      className="x1lliihq x1n2onr6 x9bdzbf"
      fill="currentColor"
      height="12"
      role="img"
      ...
      width="12"
    >
      <title>Se está reproduciendo audio</title>
